...
import { allWeather, currentDaily, geoData, weatherInfo } from "../../types/types"
...
const Main:React.FC = () => {
  const weatherInfo = useSelector((state:mainInterface) => state.weather.data)
  
  const daily:currentDaily[] = weatherInfo?.weatherData?.daily.slice(0, 7)
